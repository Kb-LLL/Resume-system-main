<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司" prop="gongsi">
          <el-input v-model="ruleForm.gongsi" 
              placeholder="公司" clearable  :readonly="ro.gongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司" prop="gongsi">
              <el-input v-model="ruleForm.gongsi" 
                placeholder="公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="简历" prop="jianli">
          <file-upload
          tip="点击上传简历"
          action="file/upload"
          :limit="1"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baomingzhaopin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baomingzhaopinCrossAddOrUpdateFlag = false;
                  this.parent.search();
