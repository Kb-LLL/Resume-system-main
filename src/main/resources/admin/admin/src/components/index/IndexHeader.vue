	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#f0ab23","headFontSize":"20px","headUserInfoFontColor":"rgb(148,98,98)","headBoxShadow":"0 10px 0px rgba(13, 142, 235, 1)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgb(209,164,15)","headFontColor":"rgb(88,164,33)","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"","headBgColor":"#f0ab23","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(255, 255, 255, 10)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
